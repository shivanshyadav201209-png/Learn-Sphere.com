...
const resourceTypePresets = {
  mathematics: ["concepts", "examples", "exercise", "extra"],
  science: ["ncertQA", "intext", "exercise", "extra"],
...
const verifiedExerciseQA = {
  // Add exact, verified, permitted Q/A here.
  // Example format:
  // "Class 10|Mathematics|Pair of Linear Equations in Two Variables|Exercise 3.2": [
  //   { q: "Question text", a: "Your original step-by-step answer" },
  // ],
};
...
function makeChapterResources(course, subject, chapter) {
  const isExam = course === "JEE" || course === "NEET";
  const sourceName = isExam ? `${course} syllabus and NCERT base` : `${course} NCERT textbook`;

  return {
    concepts: [
      {
        q: `Which concepts are important in ${chapter}?`,
        a: `Study the definitions, formulas, properties, solved examples, diagrams, and chapter summary from the ${sourceName}. Make a short list of the main ideas before solving questions.`,
      },
      {
        q: `How should I revise formulas or key points from ${chapter}?`,
        a: `Write each formula or rule with one example. Then solve two direct questions and one mixed question from ${chapter}.`,
      },
    ],
    examples: [
      {
        q: `How should I study solved examples from ${chapter}?`,
        a: `Cover the solution, try the example yourself, then compare every step. Mark the step where the method or formula is introduced.`,
      },
      {
        q: `Why are solved examples useful before NCERT exercises?`,
        a: `Solved examples show the pattern, method, and expected answer format. They prepare you for the exercise questions without memorising answers.`,
      },
    ],
    ncertQA: [
      {
        q: `What should I study first in ${chapter}?`,
        a: `Start with the definitions, examples, diagrams, formulas, and solved textbook points from the ${sourceName}. Then write the key terms of ${chapter} in your own words.`,
      },
      {
        q: `How do I write answers from ${chapter} in exams?`,
        a: `Use the NCERT wording as the base, add the correct formula or diagram where needed, and keep each answer linked to the main concept of ${chapter}.`,
      },
    ],
    textbookQA: [
      {
        q: `What type of textbook questions are asked from ${chapter}?`,
        a: `Read the chapter carefully and prepare short answers, long answers, definitions, examples, and application-based questions from the ${sourceName}.`,
      },
      {
        q: `How do I answer textbook questions from ${chapter}?`,
        a: `Use clear points, include keywords from the chapter, and keep the answer connected to the exact question asked.`,
      },
    ],
    exercise: [
      {
        q: `Choose an exercise from ${chapter}.`,
        a: `After selecting a Maths chapter, choose an exercise such as Exercise 3.2 to see exercise-wise questions and answers.`,
      },
      {
        q: `What should I revise after finishing the exercise?`,
        a: `Revise important definitions, formulas, diagrams, case-based points, and common mistakes from ${chapter}.`,
      },
    ],
    intext: [
      {
        q: `Why are intext questions important in ${chapter}?`,
        a: `Intext questions check whether you understood the concept before the final exercise. They are useful for quick oral revision and short-answer practice.`,
      },
      {
        q: `How can I prepare intext Q/A quickly?`,
        a: `Read the paragraph before each intext question, underline the direct clue, and answer in two to four clear lines.`,
      },
    ],
    grammar: [
      {
        q: `Which grammar points should I connect with ${chapter}?`,
        a: `Revise vocabulary, sentence structure, tense usage, punctuation, and important expressions that appear in the chapter.`,
      },
      {
        q: `How can I practise language questions from ${chapter}?`,
        a: `Write meanings, make sentences, identify parts of speech, and practise short answers based on the lesson.`,
      },
    ],
    writing: [
      {
        q: `What writing practice can I do after ${chapter}?`,
        a: `Write a summary, character sketch, diary entry, letter, paragraph, or value-based answer connected to the theme of ${chapter}.`,
      },
      {
        q: `How should I improve written answers?`,
        a: `Use an introduction, clear points, correct grammar, and a short conclusion. Keep the answer neat and direct.`,
      },
    ],
    mapSource: [
      {
        q: `What map or source-based practice is useful for ${chapter}?`,
        a: `Prepare locations, timelines, important events, diagrams, tables, and source-based questions related to ${chapter}.`,
      },
      {
        q: `How should I answer source-based questions?`,
        a: `Read the source twice, underline the clue words, and answer with evidence from the source plus the concept from the chapter.`,
      },
    ],
    numerical: [
      {
        q: `How should I solve numerical questions from ${chapter}?`,
        a: `Write the formula, substitute values carefully, show working steps, and mention the final unit or accounting treatment where needed.`,
      },
      {
        q: `What is the best revision method for numericals?`,
        a: `Practise one easy, one medium, and one mixed numerical from ${chapter}. Then note the common calculation mistake.`,
      },
    ],
    caseStudy: [
      {
        q: `How do I answer case-study questions from ${chapter}?`,
        a: `Identify the concept in the case, quote the relevant fact, and connect it to the theory from ${chapter}.`,
      },
      {
        q: `What should I practise for case studies?`,
        a: `Practise assertion-reason, competency-based, and situation-based questions linked with real examples from ${chapter}.`,
      },
    ],
    extra: [
      {
        q: `Give one extra practice task for ${chapter}.`,
        a: `Make a one-page revision sheet for ${chapter} with key terms, formulas, diagrams, and five self-made questions.`,
      },
      {
        q: `How can I test myself in ${chapter}?`,
        a: `Set a 20-minute timer and answer five short questions, two long questions, and one application-based question from ${chapter}.`,
      },
    ],
  };
}
...
function renderResourceTabs() {
  ...
  const types = getResourceTypes(subject);
...
function renderQuestions() {
  ...
  if (!questions.length) {
    renderEmptyState("No questions have been added for this resource type yet.");
    return;
  }
